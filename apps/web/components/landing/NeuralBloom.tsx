  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      >
        ...
        <svg
          viewBox="0 0 640 640"
          className="absolute inset-0 h-full w-full translate-x-[3%] overflow-visible md:translate-x-[4%]"
          fill="none"
          aria-hidden="true"
        >
          {layers.map((layer) => (
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 h-28 w-28 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/12 bg-white/[0.03] blur-[1px]"
        />
      </motion.div>
    </div>
  );
